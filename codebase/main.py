...
from codebase.discord_fetcher import fetch_discord_messages 
from codebase.services.discord_service import fetch_channel_messages
from codebase.services.cache_service import get_cached_analysis, save_to_cache
from codebase.services.resolve_service import load_resolved_ids
from codebase.main_pipeline import filter_resolved_from_results
from codebase.services.ui_service import MessagePaginationView, TopicPaginationView
from codebase.config import TARGET_CHANNELS
...
async def process_messages_and_send(interaction: discord.Interaction, is_clustering: bool) -> None:
    ...
    try:
        ...
        if is_clustering:
            view = TopicPaginationView(res.get("top_issues", []))
